...
public class OwnData {
    ...
    public void setUserAssist(Boolean userassist) {
    ...
    public OwnData(String place_name, String link, Integer event_id, String secretkey, String description, Boolean userassist, Boolean userlike, String event_date, Integer assistances, String image_url) {
    ...
    public OwnData(JSONObject json) {
        try {
